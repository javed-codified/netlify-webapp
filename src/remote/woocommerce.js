...
const getCategories = () => {
  ...
  return axios.get(
    `${process.env.REACT_APP_WOOCOMMERCE_API_ENDPOINT}/wp-json/wc/v3/products/categories`,
    defaultHeaders
  );
};
...
const getProductsByCategory = (category, page, per_page) => {
  ...
  return axios.get(
    `${process.env.REACT_APP_WOOCOMMERCE_API_ENDPOINT}/wp-json/wc/v3/products`,
    defaultHeaders
  );
};
...
const getCategoryById = (category_id) => {
  return axios.get(
    `${process.env.REACT_APP_WOOCOMMERCE_API_ENDPOINT}/wp-json/wc/v3/products/categories/${category_id}`,
    defaultHeaders
  );
};
...
const getPaymentInfo = () => {
  return axios.get(
    `${process.env.REACT_APP_WOOCOMMERCE_API_ENDPOINT}/wp-json/wc/v3/payment_gateways`,
    defaultHeaders
  );
};
